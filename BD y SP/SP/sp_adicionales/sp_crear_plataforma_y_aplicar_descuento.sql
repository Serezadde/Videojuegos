...
BEGIN
    ...
    -- Ejemplo de insertar un juego asociado a la nueva plataforma
    -- (Este es un ejemplo, deberías tener tu propia lógica para insertar los juegos)
    -- INSERT INTO juegos (nombre, descripcion, portada, precio, idgenero, disponible) 
    -- VALUES ('Ejemplo Juego', 'Descripción', 'img/ejemplo.jpg', 59.99, 1, 1);
    -- SET @juego_id = LAST_INSERT_ID();
    -- INSERT INTO juegos_plataformas (id_juego, id_plataforma) VALUES (@juego_id, v_id_plataforma);
